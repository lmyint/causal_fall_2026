---
title: "Testing Causal Graphs / Synthesis"
eval: false
---
...
- Reflect on your understanding of causal graphs so far.

<br>

**You can download a template file for this activity [here](templates/05-causal-graphs-testing.qmd).**
...
Think about the following questions on your own or in conversation with your group members.

- How would you explain to a friend the role that causal graphs play in a causal analysis?
- What remains uncertain or confusing? What are you still wondering about?
- Have you experienced situations in the past where it might have been useful in the past? How so?
