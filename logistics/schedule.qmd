...
<tbody>
  ...
  <tr>
    ...
    <td class="topleft"><a href="#day8">Matching</a></td>
    <td class="topleft"></td>
  </tr>
  <tr>
...
## Day 1: Matching (9/29) {#day7}

::: {.callout-note title="Required" icon=false}
- *The Effect* [Chapter 14: Matching](https://www.theeffectbook.net/ch-Matching.html) Sections 14.1-14.4 (~60 minutes)
    - Video alternatives:
...
## Day 2: Matching (10/1) {#day8}

::: {.callout-note title="Required" icon=false}
- *The Effect* [Chapter 14: Matching](https://www.theeffectbook.net/ch-Matching.html) Sections 14.5-end (~60 minutes)
    - Video alternatives:
